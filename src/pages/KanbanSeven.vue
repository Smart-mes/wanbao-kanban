<template>
  <Container id="KanbanSeven">
    <div class="head"><HeadSeven></HeadSeven></div>
    <div class="main">
      <div class="row" style="flex-direction: column;flex-grow: 0; flex-basis:25%" >
          ...
          <Box class="col" style="flex-grow: 0; flex-basis:36%; overflow: hidden;">
             <div class="row" style="flex-direction: column;">
               <div class="col"  style="flex-grow: 0; flex-basis:42px;"><h3 class="title">人员出勤状态</h3></div>
      ...
      <div class="row fb-1-2" style="flex-direction: column;">
          ...
          <Box class="col" style="overflow:hidden">
            <div class="row" style="flex-direction: column;">
              <div class="col" style="flex-grow: 0; flex-basis:42px;"><h3 class="title">生产任务明细</h3></div>
               <div class="col" style="align-items: center;">
                  <div style="width: 98%;">
                    <Table
                      class="table"
